$('.start').click(function(){
    ...
    'Mình cùng làm bánh nha','Vì hôm nay là sinh nhật của Thương, mình thấy thật phù hợp khi Thương tự làm bánh sinh nhật của mình. Bắt đầu bằng cách làm hỗn hợp bánh, sau đó nướng trong lò nướng kỹ thuật số và cuối cùng là trang trí. Chúc Thương có một sinh nhật vui vẻ và ý nghĩa nha.');
})
...
$('.mixer').click(function(){
    ...
    if(mixtimes == 6){
        $('.stage2').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','Trộn thành công','Xin chúc mừng, hỗn hợp đã hoàn hảo! Sau khi đổ hỗn hợp vào khuôn nướng, giờ là lúc cho vào lò nướng kỹ thuật số trong khoảng 3 giây. Khoảng thời gian đó đủ để tạo thành một lớp đế xốp đẹp mắt.');
...
$( ".oven" ).droppable({
    drop: function( event, ui ) {
        $('.stage3').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/oven_modal.png','Bánh đã nướng xong!','Yes! You are a master chef. The base is fully baked and looks super yummy. Now its time to combine this base with lots of other ingredients like jam, marmalade, chocolate and more.');
    }
})
